...
def process_row(im_bytes, total_time):
    ...
    if current_model in models:
        ...
        try:
            ...
            f.write(
                f'{ts},{total_processed},{avg_conf},{current_model},{current_cpu},{current_boxes},{current_time},{total_time},{absolute_time},{utility},{energy_usage},{carbon_emission_yolov5n},{carbon_emission_yolov5s},{carbon_emission_yolov5m},{carbon_emission_yolov5l},{carbon_emission_yolov5x}\n')
            f.close()
